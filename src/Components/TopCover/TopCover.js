        ...
        <div className="coverDetails-section bg-cyan-20">
          <div className="container mx-auto flex flex-col  items-center justify-center">
            ...
            <div className="container mt-5 flex flex-row justify-center space-x-10 lg:space-x-10 text-rose-600 text-xl lg:text-3xl">
              <div className="w-10 h-10 md:w-14 md:h-14 flex items-center justify-center ring-2 bg-slate-900  shadow-slate-800 rounded-full cursor-pointer hover:ring-rose-500 shadow-lg hover:text-4xl hover:scale-125 hover:transition hover:duration-700 ">
                <span className="shadow-lg shadow-slate-600 rounded-full"><FaGithub/></span>
              </div>
              <div className="w-10 h-10 md:w-14 md:h-14 flex items-center justify-center ring-2 bg-slate-900 ring-black shadow-lg shadow-slate-800 rounded-full cursor-pointer hover:ring-rose-500 hover:text-4xl hover:scale-125 hover:transition hover:duration-700 ">
                <span className="shadow-lg shadow-slate-600 rounded-full"><FaLinkedin/></span>
              </div>
              <div className="w-10 h-10 md:w-14 md:h-14 flex items-center justify-center ring-2 bg-slate-900 ring-black shadow-lg shadow-slate-800 rounded-full  cursor-pointer hover:ring-rose-500  hover:text-4xl hover:scale-125 hover:transition hover:duration-700">
